...
//     vector<vector<int>> rank;
    ...
    DisjointSet::DisjointSet(int rows, int cols){
    ...
    std::pair<int, int> DisjointSet::find(const std::pair<int, int>& cell)  {
        int x = cell.first;
        int y = cell.second;
    ...
    void DisjointSet::merge(const pair<int, int>& cell1, const pair<int, int>& cell2) {
